...
const Background = {
    ...
    BACKGROUNDR: 'flex flex-col justify-center items-center min-w-fit min-h-screen p-10 overflow-auto bg-[url("src/assets/img/backgrounds/login/background_login_little.png")] bg-cover bg-center bg-scroll'
}
